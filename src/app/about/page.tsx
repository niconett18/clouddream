    ...
    <>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#001435] rounded-lg flex items-center justify-center mb-6 mx-auto">
                <Check className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold mb-4 text-[#001435]">Kualitas</h3>
              <p className="text-[#001435] text-justify leading-relaxed text-sm">
                Kami hanya menggunakan bahan terbaik dan mempertahankan standar kontrol kualitas yang ketat untuk memastikan setiap produk memenuhi ekspektasi tertinggi.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4 text-[#001435]">Inovasi</h3>
              <p className="text-[#001435] text-justify leading-relaxed text-sm">
                Kami terus meneliti dan mengembangkan teknologi baru untuk meningkatkan kualitas tidur dengan pendekatan inovatif yang berkelanjutan.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4 text-[#001435]">Keberlanjutan</h3>
              <p className="text-[#001435] text-justify leading-relaxed text-sm">
                Kami berkomitmen pada proses manufaktur yang bertanggung jawab terhadap lingkungan untuk masa depan yang lebih berkelanjutan.
              </p>
            </div>
          </div>
        </div>
      ...
      <Section className="bg-white">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#001435]">Sertifikasi & Standar</h2>
          <p className="text-[#001435] text-lg max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {certifications.map((cert, index) => (
            <div key={index} className="text-center border border-gray-100 rounded-lg p-6">
              <div className="w-16 h-16 bg-[#001435] rounded-lg flex items-center justify-center mx-auto mb-4">
                {cert.icon}
              </div>
              <h3 className="text-lg font-semibold mb-2 text-[#001435]">
                {cert.name}
              </h3>
              <p className="text-[#001435] text-sm opacity-80">
                {cert.description}
              </p>
            </div>
          ))}
